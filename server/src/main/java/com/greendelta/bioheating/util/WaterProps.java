...
public class WaterProps {
	...
	public static double densityOf(double temp) {
		return -6.81533330354539e-12 * pow(temp, 6)
	...
	/// temperature in °C.
	public static double heatCapacityOf(double temp) {
		return 1.70768875394404e-13 * pow(temp, 6)
